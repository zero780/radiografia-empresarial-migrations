...
class CreateRadRespuestas10A2Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Rad__respuestas_10_a2', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('tipo_colaboracion',250);
            $table->timestamps();
            $table->softDeletes();
        });
    }
    ...
    {
        Schema::dropIfExists('Rad_respuestas_10_a2');
    }
}
