...
class CreateRadRespuestas6B2Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rad__respuestas_6_b2', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('id_producto')->constrained('tipo__cpcs');
            $table->boolean('se_exporta');
    ...
    {
        Schema::dropIfExists('rad__respuestas_6_b2');
    }
}
