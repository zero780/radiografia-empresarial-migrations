...
class CreateRadRespuestas2F1Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rad__respuestas_2_f1', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('id_cliente')->constrained('tipo__clientes');
            $table->foreignId('id_mercado')->nullable()->constrained('tipo__mercados');
            $table->double('porcentaje', 8, 4)->default(0);
    ...
    {
        Schema::dropIfExists('rad__respuestas_2_f1');
    }
}
