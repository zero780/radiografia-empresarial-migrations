...
class CreateRadRespuestas2D1Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rad__respuestas_2_d1', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('rad__respuestas_2_d1');
    }
}
