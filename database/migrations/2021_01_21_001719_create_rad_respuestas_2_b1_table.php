...
class CreateRadRespuestas2B1Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rad__respuestas_2_b1', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('id_producto')->nullable()->constrained('tipo__cpcs');
    ...
    {
        Schema::dropIfExists('rad__respuestas_2_b1');
    }
}
