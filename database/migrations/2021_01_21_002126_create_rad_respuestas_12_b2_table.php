...
class CreateRadRespuestas12B2Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Rad__respuestas_12_b2', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('Rad__respuestas_12_b2');
    }
}
