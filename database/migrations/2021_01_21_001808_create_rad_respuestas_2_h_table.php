...
class CreateRadRespuestas2HTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rad__respuestas_2_h', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('id_competencia')->constrained('tipo__posicionamientos');
    ...
    {
        Schema::dropIfExists('rad__respuestas_2_h');
    }
}
